...
// const loop = (count, condition, update, func) => {
//   let i = count;
//   while (condition(i)) {
//     func(i);
//     i = update(i);
...
// // const every = (arr, condition) => {
// //   return !arr.some((item) => !condition(item));
// // };
...
//   const charScript = (char = "") => {
//     const charCode = char.codePointAt(0);

//     for (let script of SCRIPTS) {
//       const isCharScript = script.ranges.some((range) => {
//         const [from, to] = range;
//         return charCode >= from && charCode < to;
//       });
//       if (isCharScript) return script;
//     }
...
//     const scriptIndex = charDirections.findIndex((s) => s.name === script.name);
...
//         count: 1,
//       });
//     } else script[scriptIndex].count += 1;
//   }

//   return charDirections.reduce((a, b) => {
